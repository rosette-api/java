...
public class ApiModelMixinModule extends EnumModule {
    ...
    public void setupModule(SetupContext context) {
        ...
        context.setMixInAnnotations(Label.class, CategoryMixin.class);
        ...
        context.setMixInAnnotations(NameComparisonRequest.class, NameMatcherRequestMixin.class);
        context.setMixInAnnotations(NameComparisonResponse.class, NameMatcherResponseMixin.class);
