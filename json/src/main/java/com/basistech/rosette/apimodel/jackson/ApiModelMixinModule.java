...
import com.basistech.rosette.apimodel.jackson.recordsimilaritydeserializers.BooleanFieldDeserializer;
...
import com.basistech.rosette.apimodel.jackson.recordsimilaritydeserializers.NumberFieldDeserializer;
import com.basistech.rosette.apimodel.jackson.recordsimilaritydeserializers.RecordSimilarityResponseDeserializer;
import com.basistech.rosette.apimodel.jackson.recordsimilaritydeserializers.StringFieldDeserializer;
...
public class ApiModelMixinModule extends AnnotatedDataModelModule {
    ...
    public void setupModule(Module.SetupContext context) {
        ...
        deserializers.addDeserializer(StringField.class, new StringFieldDeserializer());
        deserializers.addDeserializer(NumberField.class, new NumberFieldDeserializer());
        deserializers.addDeserializer(BooleanField.class, new BooleanFieldDeserializer());
