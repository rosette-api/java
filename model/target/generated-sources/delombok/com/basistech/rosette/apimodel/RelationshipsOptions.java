...
public final class RelationshipsOptions extends Options {
    ...
    @java.beans.ConstructorProperties({"accuracyMode", "discoveryMode"})
    ...
    public static class RelationshipsOptionsBuilder {
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public RelationshipsOptionsBuilder accuracyMode(final AccuracyMode accuracyMode) {
            this.accuracyMode = accuracyMode;
            return this;
        }
        ...
        @SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public RelationshipsOptionsBuilder discoveryMode(final Boolean discoveryMode) {
            this.discoveryMode = discoveryMode;
            return this;
        }
    ...
    @SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public static RelationshipsOptionsBuilder builder() {
        return new RelationshipsOptionsBuilder();
    }
