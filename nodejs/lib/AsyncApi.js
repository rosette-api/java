...
////api.retryingRequest(printIt, "GET", api.serviceUrl + "/ping", {user_key: api.userKey});
//var docParams = new DocumentParameters();
//docParams.setItem("content", "testing this out. Let's see");
////API.callEndpoint(printIt, docParams, "language");
//API.categories(docParams, printIt);
